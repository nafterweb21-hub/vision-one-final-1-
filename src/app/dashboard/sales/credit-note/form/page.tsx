...
import { getInvoiceFormData, getPendingDOs, getDOItemsForInvoice, getInvoice, createInvoice, updateInvoice, reviseInvoice, submitInvoice, voidInvoice } from "../credit-note.actions";
    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6 pb-24">
      <div className="flex items-center justify-between pb-6 border-b border-blue-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-blue-900">{isEdit ? "Credit Note Details" : "New Credit Note"}</h1>
