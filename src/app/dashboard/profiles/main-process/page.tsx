...
export default function MainProcessPage() {
  ...
  const handleVoidProcess = async (id: string) => {
    if (!await customConfirm("Are you sure you want to VOID this main process? Voided records cannot be restored and running audit logs are permanently maintained.")) {
      return;
    }
    ...
    try {
      ...
      hotToast.error(err.message || "Failed to void process.");
    }
  };
