...
export default function materialTypesPage() {
  ...
  const handleVoidtype = async (id: string) => {
    if (!await customConfirm("Are you sure you want to VOID this Material Type? Voided records cannot be restored and running audit logs are permanently maintained.")) {
      return;
    }
