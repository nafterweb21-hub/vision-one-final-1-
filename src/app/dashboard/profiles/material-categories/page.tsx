...
export default function MaterialCategoriesPage() {
  ...
  const handleVoidCategory = async (id: string) => {
    if (!await customConfirm("Are you sure you want to VOID this material category? Voided records cannot be restored and running audit logs are permanently maintained.")) {
      return;
    }
    ...
    try {
      ...
      hotToast.error(err.message || "Failed to void category.");
    }
  };
