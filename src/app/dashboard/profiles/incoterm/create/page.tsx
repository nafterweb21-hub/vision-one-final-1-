...
export default function CreateIncotermProfilePage() {
  return (
    <div className="space-y-6 animate-fade-in relative min-h-screen">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-blue-500 ">
          Configure a new Incoterm to be used across material profile catalogs.
        </p>
      </div>

      <IncotermProfileForm editingProfile={null} />
