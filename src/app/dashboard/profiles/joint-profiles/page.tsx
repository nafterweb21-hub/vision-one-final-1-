...
export default function materialJointsPage() {
  ...
  const handleVoidjoint = async (id: string) => {
    if (!confirm("Are you sure you want to VOID this Joint Profile? Voided records cannot be restored and running audit logs are permanently maintained.")) {
      return;
    }
    ...
    try {
      ...
      alert(err.message || "Failed to void joint.");
    }
  };
