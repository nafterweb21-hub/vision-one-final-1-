      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between bg-white border border-slate-200 shadow-sm rounded-3xl p-4 mb-8">
        <div className="flex items-center gap-4">
          ...
          <div className="text-right flex items-center gap-4">
            <div>
              <div className="text-xs font-medium text-gray-400 uppercase tracking-wider">Operator</div>
              <div className="text-sm font-semibold">{activeEmployee.name}</div>
            </div>
            {!displayEmployee && (
              <button 
                onClick={() => setLocalEmployee(null)}
                className="p-2 hover:bg-slate-100 rounded-full transition-colors text-gray-400 hover:text-slate-900"
                title="Logout"
              >
